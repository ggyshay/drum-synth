...
class FM : public InstrumentI {
  public:
    FM() {
      Value  frequency1Value(30.0, 3600.0, 100.0, "TOM 1");
      values.push_back(frequency1Value);

      Value  frequency2Value(30.0, 3600.0, 800.0, "TOM 2");
      values.push_back(frequency2Value);

      Value  decay1Value(30.0, 1000.0, 50.0, "DURACAO 1");
      values.push_back(decay1Value);

      Value  decay2Value(30.0, 1000.0, 50.0, "DURACAO 2");
